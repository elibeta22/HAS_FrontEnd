                        ...
                        <View style={styles.container}>
                            <View style={styles.topContainer}>
                                <View style={styles.iconContainer}>
                                    <Icon name='university' color='rgb(66,67,69)' type='font-awesome' size={totalSize(4)} />
                                </View>
                                <View style={styles.txtContainer}>
                                    <View>
                                        <Text style={styles.txtLarg}>{store.SCHOOL.school.school_name}</Text>
                                    </View>
                                    <View >
                                        <Text style={styles.txtSmall}>{store.SCHOOL.school.school_location}</Text>
                                    </View>
                                </View>
                            </View>
